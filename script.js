...
const PRODUCTS = {
    earbuds: {
        ...
        reviews_data: [
            { name: 'David K.', rating: 5, date: 'March 2026', comment: 'Incredible sound quality for the price. The noise cancellation works really well in noisy environments. Battery life is solid.' },
            { name: 'Sarah M.', rating: 4, date: 'February 2026', comment: 'Very comfortable to wear for long periods. Sound is excellent. Would love slightly stronger bass.' },
            { name: 'James O.', rating: 5, date: 'January 2026', comment: 'Best earbuds I\'ve used at this price point. The touch controls are very responsive.' },
        ],
